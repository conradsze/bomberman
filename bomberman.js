...
if (Meteor.isClient) {
  ...
  Template.bomberman.helpers({
    bomberman: function() {
      ...
      var game = new Phaser.Game(900, 636, Phaser.AUTO, 'phaser-example', {
        preload: preload,
        create: create,
        update: update
      });
      ...
      function create() {
        ...
        game.input.keyboard.addKey(Phaser.Keyboard.LEFT).onUp.add(function() {
          gameStream.emit('Movement', {
            x: jimmy.x,
            y: jimmy.y,
            dir: "left",
        ...
        game.input.keyboard.addKey(Phaser.Keyboard.RIGHT).onUp.add(function() {
          gameStream.emit('Movement', {
            x: jimmy.x,
            y: jimmy.y,
            dir: "right",
        ...
        game.input.keyboard.addKey(Phaser.Keyboard.A).onUp.add(function() {
          gameStream.emit('Movement', {
            x: glenn.x,
            y: glenn.y,
            dir: "left",
        ...
        game.input.keyboard.addKey(Phaser.Keyboard.D).onUp.add(function() {
          gameStream.emit('Movement', {
            x: glenn.x,
            y: glenn.y,
            dir: "right",
        ...
        game.input.keyboard.addKey(Phaser.Keyboard.W).onUp.add(function() {
          gameStream.emit('Movement', {
            x: glenn.x,
            y: glenn.y,
            dir: "up",
        ...
        game.input.keyboard.addKey(Phaser.Keyboard.S).onUp.add(function() {
          gameStream.emit('Movement', {
            x: glenn.x,
            y: glenn.y,
            dir: "down",
      ...
      function update() {
        ...
        game.physics.arcade.collide(jimmy, bombs, function() {
          gameStream.emit('kick', {
            x: jimmy.x,
            y: jimmy.y,
            vx: jimmy.body.velocity.x,
            vy: jimmy.body.velocity.y,
            name: "jimmy"
          })
        }, null, this);
        ...
        game.physics.arcade.collide(glenn, bombs, function() {
          gameStream.emit('kick', {
            x: glenn.x,
            y: glenn.y,
            vx: glenn.body.velocity.x,
            vy: glenn.body.velocity.y,
            name: "glenn"
          })
        }, null, this);
      ...
      function makeitem(x, y, name) {
        ...
        if (name == "shoes") {
          ...
          shoes = item.create(x, y, 'shoes');
        } else if (name == "skate") {
          if (skate) {
            skate.kill()
          };
          skate = item.create(x, y, 'skate');
        } else if (name == "food") {
          if (food) {
            food.kill()
          };
          food = item.create(x, y, 'food');
        } else if (name == "cane") {
          if (cane) {
            cane.kill()
          };
          cane = item.create(x, y, 'cane');
        }
